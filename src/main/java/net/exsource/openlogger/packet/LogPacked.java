package net.exsource.openlogger.packet;
 ...
 * @author Niklas Tat
 */
public class LogPacked implements Serializable {
    ...
    public LogPacked(String message, List<String> messageList, LogLevel logLevel) {
     ...
     * use {@link LogPacked (String, LogLevel)}
     *
     * @see Logger
     ...
     */
    public LogPacked(String message) {
     ...
     */
    public LogPacked(String message, LogLevel logLevel) {
     ...
     * want to change it directly just use the method {@link LogPacked (List, LogLevel)}
     ...
     */
    public LogPacked(List<String> messageList) {
     ...
     */
    public LogPacked(List<String> messageList, LogLevel logLevel) {
