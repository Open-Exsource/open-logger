...
public interface Logger {
     ...
     */
    void print(LogPacked logObject);
     ...
     */
    void debug(LogPacked logObject);
     ...
     * @param logObject the created LogObject with all variables filled
     */
    void error(LogPacked logObject);
     ...
     * @param logObject the created LogObject with all variables filled
     */
    void fatal(LogPacked logObject);
     ...
     * @param logObject the created LogObject with all variables filled
     */
    void empty(LogPacked logObject);
     ...
     * you don't know what you're doing. Instand of the {@link LogPacked} use a
     ...
     */
    void list(LogPacked logObject, String headline);
     ...
     * @param consoleColor the color of the border elements
     */
    void list(LogPacked logObject, String headline, ConsoleColor consoleColor);
     ...
     * {@link LogPacked} use a {@link List} wich all messages contains. It's easier and
     ...
     * @param lineChar the char of the border elements
     */
    void list(LogPacked logObject, String headline, char lineChar);
     ...
     * to create a {@link LogPacked} and fill out all variables.
     * Please use this method only if you know what you're doing.
     * Instant of this change the {@link LogPacked} to a {@link List}
     ...
     * @param consoleColor the color of the border elements
     */
    void list(LogPacked logObject, String headline, char lineChar, ConsoleColor consoleColor);
